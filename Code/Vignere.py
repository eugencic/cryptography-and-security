...
class Vignere:
  ...
  # Encrypt the message which takes two arguments. One is the message that needs to be encrypted and the second argument is the key that returns the encrypted text  
  def encrypt(self, message, key): 
    ...
    for letter in message:
      if letter in alphabet:
        # Cycle through each letter to find it's numeric position in the alphabet
  ...
  # Decrypt the message which takes two arguments. One is the message that needs to be encrypted and the second argument is the key that returns the encrypted text  
