...
if __name__=='__main__':
    message = (input('Enter the text you want to encrypt (uppercase): ').upper()).replace(" ", "")
    key = (input('Enter the secret message: ').upper()).replace(" ", "")
    encrypted_message = playfair(message, key)
    print("Encrypted message: ", encrypted_message) 
    decrypted_message = playfair(encrypted_message, key, False)
